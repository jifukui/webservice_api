...
#define LIG_MATRIX_MEVENT_CARD_PARAM_CHANGE        (0x1<<14) //子板参数改变，如网络参数配置
...
//FOR SIGNAL,LIG_MATRIX_MEVENT_PIPE_PARAM_CHANGE
#define LIG_MATRIX_SIG_GET_PIPE_ID(sig_param)	((sig_param>>16)&0x00ff)
#define LIG_MATRIX_SIG_GET_PIPE_PARAMID(sig_param)	((sig_param>>24)&0x00ff)
#define LIG_MATRIX_SIG_GET_PIPE_IRQPID(sig_param) (sig_param&0x0ffff)

#define LIG_MATRIX_SIG_PIPE_CHANGE_PARAM(pid,pipe_id,param)	((pid&0xffff)|(pipe_id&0xff)<<16|(param&0xff)<<24)
...
typedef enum
{
	...
	em_matrix_btype_EMonitor,
	em_matrix_btype_UHD2,
	em_matrix_btype_UHDA2,
...
typedef enum
{
 em_matrix_card_param_irq_unknown = -1,
 em_matrix_card_param_irq_reset = 0,
 em_matrix_card_param_irq_mac = 1,
 em_matrix_card_param_irq_ip = 2,
 em_matrix_card_param_irq_mask = 3,
 em_matrix_card_param_irq_gate = 4,
 em_matrix_card_param_irq_tcp = 5,
 em_matrix_card_param_irq_udp = 6,
}EM_MATRIX_CARD_PARAM_IRQ_TYPE;

/*******************************
-Define Name   : lig_matrix_get_card_param_irq_slot
-Description   : 获取内部信号LIG_MATRIX_MEVENT_CARD_PARAM_CHANGE参数中的子板插槽编号
-Input	Param  : inner_param from in (struct  sig_flag).src_parameter
-Author        : zouyuan@liguodz.com 2018/10/31
*********************************/
#define lig_matrix_get_card_param_irq_slot(inner_param)	((inner_param&0x00ff0000)>>16)

/*******************************
-Define Name   : lig_matrix_get_card_param_irq_type
-Description   : 获取内部信号LIG_MATRIX_MEVENT_CARD_PARAM_CHANGE参数中的子板参数类型
-Input	Param  : inner_param from in (struct  sig_flag).src_parameter
-Author        : zouyuan@liguodz.com 2018/10/31
*********************************/
#define lig_matrix_get_card_param_irq_type(inner_param)	((inner_param&0xff000000)>>24)
...
em_contrast                     =21,
em_hue                          =22,
em_color_saturation             =23,
em_sharpness                    =24,
em_color_temperature            =25,
em_motion_contrast              =26,
em_gamma                        =27,
em_video_filter_type_set        =28,
em_y_delay                      =29,
em_phase_adjustment             =30,
em_gain_adjustment              =31,
em_equalization_adjustment      =32,
em_emphasis_adjustment          =33,
em_compensation_adjustment      =34,
em_fan_status                   =35,
em_card_port_reset              =36,
em_scale_cut_mode               =38,
em_out_windows_adjust           =39,
em_video_freeze                 =40,
em_tv_format                    =41,
em_video_format                 =42,
em_picture_aspect_ratio_mode    =43,
em_pbp_adjustment               =44,
em_out_resolution               =45,
em_input_hor_position_adjustment=46,
em_input_ver_position           =47,
em_input_hor_size_adjustment    =48,
em_input_ver_size_adjustment    =49,
em_output_hor_position_adjustment=50,
em_output_ver_position_adjustment=51,
em_output_hor_size_adjustment    =52,
em_output_ver_size_adjustment    =53,
em_zoom_b_hor_position_adjustment=54,
em_zoom_b_ver_position_adjustment=55,
em_zoom_b_hor_size_adjustment    =56,
em_zoom_b_ver_size_adjustment    =57,
em_zoom_w_hor_position           =58,
em_zoom_w_ver_position           =59,
em_zoom_w_hor_size_adjustment    =60,
em_zoom_w_ver_size_adjustment    =61,
em_resolution                    =62,
em_hor_total_pixels_set          =64,
em_ver_total_pixels_set          =65,
em_get_max_input_pixel_clock     =66,
em_horizontal_start              =67,
em_horizontal_active             =68,
em_vertical_start                =69,
em_vertical_active               =70,
em_dp_channels                   =71,
em_dpcp                          =72,
em_restore_setup                 =73,
em_recall_setup                  =74,
em_switch_speed                  =75,
em_volume                        =81,
em_background_volume             =82,
em_mic_volume                    =83,
em_audio_balance                 =84,
em_background_balance            =85,
em_mic_balance                   =86,
em_audio_bass                    =87,
em_audio_treble                  =88,
em_audio_sample_frequency        =89,
em_audio_sample_size             =90,
em_audio_mute                    =91,
em_audio_midrange                =92,
em_audio_loudness                =93,
em_audio_mix_mode                =94,
em_audio_stereo_mode             =95,
em_audio_talk_over               =96,
em_audio_aux_delay               =97,
em_audio_select                  =98,
em_audio_channel                 =99,
em_matrix_audio_direction        =100,
em_matrix_audio_source           =101,
em_arc_enable                    =102,
em_arc_audio_source              =103,
em_ext_audio_out_direction       =104,   //3.5 direction select
em_ext_audio_out_source          =105,   //3.5 source select
em_hdmi_audio_out_source         =106,
em_hdcp_in_version               =110,   //only for input port
em_signal_information            =121,
em_inport_information            =122,
em_monitor_information           =123,
em_outport_information           =124,
em_temperature                   =125,
em_voltage                       =126,
em_edid_status                   =127,
em_bus_status                    =128,
em_aud_act_speed                 =151,   //自定义参数，会出现不同子板，参数相同，但功能不同的情况
em_hdcp_in_enable                =155,
em_hdbt_long_mode                =156,
em_analog_audio_setting          =158,   //ST
...
/*=============BACK_BOARD START=======================*/
        ...
        *********************************/
        extern int32_t lig_matrix_get_port_parameter_list(void *handle,uint32_t port_id,
        		                                              EM_MATRIX_PARA_LIST *listbuf,
															             uint8_t buflen,uint16_t *para_list_len);
        ...
        -返回值：                0=success 其他 参考错误定义
        *********************************/
        extern int32_t lig_matrix_get_port_parameter_attribute(void *handle,uint32_t port_id ,
        		                                                    EM_MATRIX_PARA_LIST para,
																	             LIG_MATRIX_OBJ_PARA_ATTRIBUTE *para_attr);
          //查询端口参数是否支持关联
        extern EM_MATRIX_PARA_RELEVANCE lig_matrix_get_port_parameter_relevance(void *handle,
																			                       uint32_t port_id,
																			                       EM_MATRIX_PARA_LIST param_sid);
	      //>0 获得name的字符串长度，<0 参考错误定义
	     extern int32_t lig_matrix_get_port_parameter_name(void *handle,
														                uint32_t port_id,
														                EM_MATRIX_PARA_LIST param_sid,
																	       char *get_name_buffer, int name_buffer_len);
        /*******************************
        ...
        -返回值：                0=success 其他 参考错误定义
        *********************************/
        extern int32_t lig_matrix_set_port_parameter_value(void *handle,uint32_t port_id ,
        		                                               EM_MATRIX_PARA_LIST para,uint32_t para_vol);
        ...
        -输入参数说明:          handle 设备句柄
                         port_id=[1，34] 端口编号
                         param_id 参考 EM_MATRIX_PARA_LIST
                         get_value 要获取的参数值缓冲（对于选项型参数，此处回送的参数可以参考对应参数的ENUM值）
                         get_value_buflen 参数值缓存长度，uint32_t个数;
                         get_value_len：获取到参数的缓冲长度
        -返回值：                0=success 其他 参考错误定义
        *********************************/
        extern int32_t lig_matrix_get_port_parameter_value(void *handle,uint32_t port_id,
        		                                               EM_MATRIX_PARA_LIST param_id,
															              uint32_t *get_value, uint16_t get_value_buflen,
																		     uint16_t *get_value_len);
...
/*******************************
-Function Name : lig_matrix_pipe_param_disable_sig/lig_matrix_pipe_param_enable_sig
-Description   : 关闭/打开pipe_param_change信号的发送
-Called By     : app
-Input  Param  : handle :设备句柄
-Return Value  : 
-Author        : zhangbin.eos@foxmail.com 29/10/2018
*********************************/
extern void lig_matrix_pipe_param_disable_sig(void*handle);
extern void lig_matrix_pipe_param_enable_sig(void*handle);

/*******************************
-Function Name : lig_matrix_pipe_param_sendall_sig
-Description   : 发送统一的端口参数变化信号,
                 配合lig_matrix_pipe_param_disable_sig使用,
                 用于处理端口参数设置密集的情况,
                 信号发送不受ig_matrix_pipe_param_disable_sig的影响
-Called By     : app
-Input  Param  : handle :设备句柄
                 pipe   :端口id
-Return Value  : 
-Author        : zhangbin.eos@foxmail.com 29/10/2018
*********************************/
extern int32_t lig_matrix_pipe_param_sendall_sig(void*handle, int pipe);
...
-Called By     : app
-Input  Param  : handle :设备句柄
					  slot_id ：0主控制板， 1-17 对应的slot，203-LinuxARM,205-EM;206-M21167
-Return Value  : 0=success;(ERROR)=参考错误定义
*********************************/
...
-Return Value  : 0=success;(ERROR)=参考错误定义
*********************************/
extern int32_t lig_matrix_set_inner_signal_power_alarm_opt(void*handle,uint32_t slot_id);
	...
	-Description   : 暂存切换数据,删除重复切换的数据,
	                 =lig_matrix_set_video_switch+lig_matrix_stash_video_switch_data
	-Call          :
	-Called By     :
	-Input  Param  :
	-Output Param  :
	...
	*********************************/
	extern int32_t ex_lig_matrix_stash_video_switch_data(void*handle,uint32_t video_in,uint32_t video_out);
	...
	*********************************/
        ...
        *********************************/
        ...
        /*******************************
       		-函数名:             lig_matrix_get_active_audio_pipe_io
       		-函数功能描述:       获取音频管道的方向，需要判断端口是否有效（双联板的第二个端口），以及当前子板是否支持音频矩阵
       		-调用清单:
       		-何处调用：
       		-输入参数说明:        handle 设备句柄
       					   pipnum=[1,MAX]
       		...
       		-返回值：            参考enum定义
       	*********************************/
      	extern EM_MATRIX_IO_TYPE lig_matrix_get_active_audio_pipe_io(void*handle,uint32_t pip_id);
		...
		*********************************/
		...
		-返回值：                参考错误定义
		*********************************/
        extern int32_t lig_matrix_set_card_net_port(void *handle ,uint32_t slot_id,
        		                                       EM_MATRIX_NET_PORT_TYPE port_type,
														         uint16_t port_val);
		/*******************************
		...
		*********************************/
        ...
        extern int32_t lig_matrix_get_port_real_edid(void*handle, uint32_t pip_id,EM_MATRIX_EDID_TYPE edid_type,
        		uint8_t *edid_buf,uint16_t buf_len);
		/*******************************
